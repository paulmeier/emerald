...
class MachinesControllerTest < ActionController::TestCase
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post :create, machine: { id: @machine.id, location: @machine.location, name: @machine.name, serialNumber: @machine.serialNumber }
    end
  ...
  test "should update machine" do
    put :update, id: @machine, machine: { id: @machine.id, location: @machine.location, name: @machine.name, serialNumber: @machine.serialNumber }
    assert_redirected_to machine_path(assigns(:machine))
  end
